...
def _check_easteregg_env() -> bool:
    ...
    env_flag = os.environ.get(f'{SRC_FOLDER_NAME.upper()}_GUI_EASTEREGG', '').strip().lower()
...
def __getattr__(name: str):
    ...
    if name == "generate_cast_template":
        from .core import generate_cast_template
        return generate_cast_template
