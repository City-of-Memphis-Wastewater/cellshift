...
from cellshift.paths import SRC_FOLDER_NAME
from maxson_build_utils.build_pyz import run_build_pyz

'''
=======
from build_executable import form_dynamic_name # this is gross pleaae modularize
...
# --- Configuration ---
ENTRY_POINT = "cellshift.cli:app" # pull from pyproject.toml?
...
>>>>>>> 60e6c67 (chip away at pyz build modularity)
'''
if __name__ == "__main__":
    run_build_pyz(
        src_folder_name=SRC_FOLDER_NAME,
        version=__version__,
        entry_point="cellshift.__main__:app",
    )
